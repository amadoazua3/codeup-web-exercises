...
//-----------------------------------------------------------
//----------- Using a forLoop for the solution
    ...
    //
    //         console.log(`${obj[i].name} has a bill of $${obj[i].amount}.`);
    //
    //         if(obj[i].amount > 200){
    //
    //             discount = obj[i].amount * 0.12;
    //             newTotal = obj[i].amount - discount;
    //
    //             console.log(`After the discount ${obj[i].name}'s total is $${newTotal}`);
    //         }
    //     }
    // }
    //
    ...
    // }
    //
    // showBookInfo(createBook("APOSIMZ", "Tsutomo Nihei"));

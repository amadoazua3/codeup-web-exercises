...
// create a handler function
    ...
    var newBackground = document.body.style.backgroundColor;

    document.body.style.backgroundColor = '#34363a';

    var mainHeader = document.getElementById("main-header");

    mainHeader.innerHTML = "GOODNIGHT TOKYO!";

    mainHeader.style.color = "white";

    var bodyText = document.getElementById("body-txt")

    bodyText.style.color = "orange";

    }

    // registering the listener to handle clicks on sus

    document.getElementById('clicker').addEventListener('click', listener);
